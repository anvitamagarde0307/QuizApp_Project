...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        opt1.setBounds(154, 438, 287, 32);
        opt1.setBackground(new Color(22, 3, 30));
        opt1.setForeground(new Color(239, 235, 241));
        opt1.setFont(new Font("Dialog", Font.PLAIN, 18));
        add(opt1);

        opt2 = new JRadioButton();
        opt2.setBounds(558, 438, 287, 32);
        opt2.setBackground(new Color(22, 3, 30));
        opt2.setForeground(new Color(242, 240, 243));
        opt2.setFont(new Font("Dialog", Font.PLAIN, 18));
        add(opt2);

        opt3 = new JRadioButton();
        opt3.setBounds(154, 538, 287, 32);
        opt3.setBackground(new Color(22, 3, 30));
        opt3.setForeground(new Color(243, 240, 244));
        opt3.setFont(new Font("Dialog", Font.PLAIN, 18));
        add(opt3);

        opt4 = new JRadioButton();
        opt4.setBounds(558, 538, 287, 32);
        opt4.setBackground(new Color(22, 3, 30));
        ...
        help.setForeground(new Color(40, 2, 58));
